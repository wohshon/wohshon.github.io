...
In this case, a `PersonEntity` is used as the domain object (with fields like id, name, email) nothing fanciful but getting the work of writing correct protobuf schemas and syntax out of the way.
